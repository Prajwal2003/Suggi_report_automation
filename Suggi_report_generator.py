...
pattern2 = "input/TBD*.csv"
pattern3 = "input/SBD*.csv"
pattern4 = "input/CBD*.csv"
pattern5 = "input/CI_*.csv"
pattern6 = "input/CIB_E*.csv"
pattern7 = "input/SI_*.csv"
pattern9 = "input/SIB_E*.csv"
pattern8 = "input/TWC*.csv"
...
matching_files2 = [os.path.basename(file) for file in matching_files2]
matching_files3 = [os.path.basename(file) for file in matching_files3]
matching_files4 = [os.path.basename(file) for file in matching_files4]
matching_files5 = [os.path.basename(file) for file in matching_files5]
matching_files6 = [os.path.basename(file) for file in matching_files6]
matching_files7 = [os.path.basename(file) for file in matching_files7]
matching_files8 = [os.path.basename(file) for file in matching_files8]
matching_files9 = [os.path.basename(file) for file in matching_files9]
